...
CREATE TABLE movie (
    ...
    posterurl VARCHAR(200) DEFAULT "https://pics.filmaffinity.com/Metr_polis-434117468-large.jpg", -- URl del cartel (foto pelicula), tipo varchar máximo 100, tiene valor por defecto
    PRIMARY KEY (id),
